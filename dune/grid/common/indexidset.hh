...
#undef CHECK_AND_CALL_INTERFACE_IMPLEMENTATION
  ...
  public:
     ...
     *
     * \tparam  Entity  type of entity (must be Codim< Entity::codimension >::Entity)
     *
     * \param[in]  e      reference to entity
     * \param[in]  i      number subentity of e within the codimension
     * \param[in]  codim  codimension of the subentity we're interested in
     ...
     */
    template<class Entity, std::enable_if_t<std::is_same<typename Codim<Entity::codimension>::Entity, Entity>::value, int> = 0>
